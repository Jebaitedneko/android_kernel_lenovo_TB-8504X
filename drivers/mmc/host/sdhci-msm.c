...
#include <linux/device.h>/* add  mike_zhu 20181207 card slot info for factory mode       */
#include "sdhci-msm.h"
...
/* add mike_zhu 20181207  card slot info for factory mode    start  */
...
static int sdhci_msm_probe(struct platform_device *pdev)
{
	...
	}else{ /* add mike_zhu 20181207  card slot info for factory mode    */
